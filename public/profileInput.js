const ProfileInput = function(searchInput, profileList, repoList) {
  ...
  this.searchInput.addEventListener('keyup', function() {
    ...
    this.repoList.url = 'https://api.github.com/users/' + value + '/repos?per_page=10&sort=created&client_id=' + this.profileList.client_id + '&client_secret=' + this.profileList.client_secret;
